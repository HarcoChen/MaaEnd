...
import (
	...
	"github.com/MaaXYZ/MaaEnd/agent/go-service/buygoodselastic/levenshtein"
)
...
// 例如：输入 "ValleyIV/OriginiumSaplings.Tier3" 返回 "BuyGoods/Goods/ValleyIV/OriginiumSaplings.Tier3.png"
func BuildTemplatePath(id string) string {
	return filepath.ToSlash(filepath.Join("BuyGoods", "Goods", id+".png"))
}
